// app/staff-dashboard/clinical/records/[id]/page.tsx

// TO-DO: there is an error here after creating a visit, it doesn't show it, fix it for both clinics and vet
...
export default async function VisitRecordDetailPage({ params }: Readonly<PageProps>) {
