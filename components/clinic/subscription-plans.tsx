...
const PLANS: PlanDefinition[] = [
    ...
    },
    {
        ...
        features: [
            ...
            "Up to 150 patients",
            "Inventory & POS (up to 25 SKUs)",
            "60–80 reminders / month",
            "Everything in Free",
        ],
        purchasable: true,
    },
    {
        ...
        price: "₦41,000",
        period: "/mo",
        tagline: "Unlimited everything, plus AI-powered tools",
        features: [
    ...
    },
    {
        ...
        features: ["Custom pricing", "Dedicated support", "Details coming soon"],
        purchasable: false,
    },
];
