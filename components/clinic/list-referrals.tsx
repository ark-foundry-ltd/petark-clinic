...
import ReferralsAnalyticsWidget from "../referrals/referral-analytics-widget";
...
export default function ListReferrals({
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 pry-ff space-y-4">
      <div className="mb-6">
